	...
	<div class="container mt-4">
		...
		<div class="card text-white text-center col-6 mx-auto">
			...
			<div class="card-body">
				...
				<form id="loginForm" name="loginForm" action="/home" method="GET">

					<div class="form-row">
						<div class="form-group col-sm-12">

							<label path="name">Username</label> <input class="form-control"
								type="text" name="name" placeholder="Enter your Username"></input>
							<br>
						</div>
					</div>
					<div class="form-row">
